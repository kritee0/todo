...
const Status = ({openStatus,setOpenStatus}) => {
  ...
  return (
    ...
    <div className=' max-w-xs h-auto z-10   bg-blue-950 px-2 border-2 border-gray-400 cursor-pointer  text-white  rounded-xl  mb-2 border-b-2 border-b-white'>
        <div className=" relative text-bold text-lg flex  text-white items-center justify-center" onClick={()=>setOpenStatus(prev=>!prev)} 
            >
                <RiFilter3Line/>
            ...
            {openStatus &&(
                ...
                <ol>
                <li className='  hover:bg-black/20 ' onClick={()=>handleSelect(pending)}>Pending</li>
                <li className=' hover:bg-black/20' onClick={()=>handleSelect(complete)}>Complete</li>
                <li className=' hover:bg-black/20' onClick={()=>handleSelect(ongoing)}>Ongoing</li>
                <li className=' hover:bg-black/20'>Abundant</li>
          </ol>
